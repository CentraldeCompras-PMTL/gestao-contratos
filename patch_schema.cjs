...
// 1. Add `status` column to processosDigitais
code = code.replace(
...
// 2. Add `processo_participantes`, `processo_itens` etc tables
const newTables = `
...
// 3. Add to processosDigitaisRelations and add new relations
const newRelations = `
...
// 5. Append insert schemas and type definitions to the end
const finalCode = `
